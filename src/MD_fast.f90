...
subroutine calc_force_pair
    ...
    do i=1,nlist
        ...
        !
        r8 = fij(eps(atype(listi(i)),atype(listj(i))), sig(atype(listi(i)),atype(listj(i))), rcsq, rabssq)
        f_Iam(1:3,listi(i)) = f_Iam(1:3,listi(i)) + r8*r(1:3)
        f_Iam(1:3,listj(i)) = f_Iam(1:3,listj(i)) - r8*r(1:3)
    end do
    !
...
subroutine calc_force_bonds
    ...
    do i=1+Iam,nbonds,Nproc
        ...
        f_Iam(1:3,bondi(i)) = f_Iam(1:3,bondi(i)) + fij*r(1:3)
        f_Iam(1:3,bondj(i)) = f_Iam(1:3,bondj(i)) - fij*r(1:3)
    end do
    !
