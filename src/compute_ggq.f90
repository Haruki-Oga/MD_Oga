...
contains
    subroutine init_compute_ggq
        ...
        ! ===
    end subroutine init_compute_ggq
    !
    !
    ! --- compute temperature ---
    subroutine compute_ggq
        use update_mod
        use commn
        use constant_mod
        use fix_compute_mod
