...
module compute_ggq_hf_mod
    ...
    !
contains
    subroutine init_compute_ggq_hf
        use update_mod
        use commn
        use file_mod
        use constant_mod
        ...
        ! ===
    end subroutine init_compute_ggq_hf
    !
    !
    ! --- compute temperature ---
    subroutine compute_ggq_hf
        use update_mod
        use commn
        use constant_mod
        use fix_compute_mod
