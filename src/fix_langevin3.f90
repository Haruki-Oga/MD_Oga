...
contains
    subroutine init_fix_langevin3
        ...
        ! ===
    end subroutine init_fix_langevin3
    !
    ! --- langevin thermostat ---
    subroutine fix_langevin3
        use update_mod
        use commn
        implicit none
    ...
    end subroutine fix_langevin3
    !
    ! --- compute culumtive enerty ---
    subroutine fix_langevin3_compute
        use update_mod
        use commn
        use constant_mod
        use fix_compute_mod
        ...
        !end do
    end subroutine fix_langevin3_compute
end module fix_langevin3_mod
